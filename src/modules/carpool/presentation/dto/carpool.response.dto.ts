...
export class CarpoolResponseDto {
    ...
    @ApiProperty({example: 37.5, type: Number, format: 'double', nullable: true })
    originLat: number | null;

    @ApiProperty({example: 127.0, type: Number, format: 'double', nullable: true })
    originLng: number | null;

    @ApiProperty({example: 37.3, type: Number, format: 'double', nullable: true })
    destLat: number | null;

    @ApiProperty({example: 127.1, type: Number, format: 'double', nullable: true })
    destLng: number | null;
    ...
    @ApiProperty({example: "2025-11-30T09:12:33.123Z", format: "date-time", required: true})
    createdAt: string;

    @ApiProperty({example: "2025-11-30T10:15:21.789Z", format: "date-time", required: true})
    updatedAt: string;
...
export class CarpoolDetailResponseDto {
    ...
    @ApiProperty({ type: CarpoolDriverInfoDto, example: {id:2,name:'testDriver',phone:'010-9876-5432'} })
...
export type CarpoolWithDriverInfoListResponse = CarpoolWithDriverInfoResponseDto[];
export type carpoolWithDriverInfoSingleResponse = CarpoolWithDriverInfoResponseDto | null;
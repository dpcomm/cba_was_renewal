...
export class ExpoNotificationService {
    ...
    async reserve(dto: reservePushNotificationRequestDto): Promise<reservationPushNotificationResponseDto> {
        // ID 발급 (간단 & 충돌 없음)
    ...
    async cancelReservation(reservationId: number): Promise<reservationPushNotificationResponseDto> {
    ...
    async popDueReservations(nowMs: number,): Promise<reservationPushNotificationResponseDto[]> {
        // 실행 대상 조회
